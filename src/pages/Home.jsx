...
import {Button, Box, TextField, InputAdornment, Divider} from "@material-ui/core";
        ...
        <div className="Home">
            <div className="Home-Meeting">
                <div className="Home-Meeting-Description">
                    ...
                    <p className="GoogleMeetDescription">Conecta, colabora y celebra desde cualquier lugar con Google Meet</p>
                </div>
                <div className="Home-Meeting-Buttons">
                    ...
                    <div className="LinkContainerOne">
                        ...
                        <div style={{ marginTop: '2rem' }}>
                            <a className="Link" href="https://meet.google.com/about/redirect/landing-learn-more/?hl=es" target="_blank">Más información sobre Google Meet</a>
                        </div>
                    </div>
                </div>
            </div>
